...
if __name__ == '__main__':
    ...
    # Model Parameters
    parser.add_argument('--input_features', type=int, default=6, metavar='IN',
                       help='number of inputs to the model (default:2)')
    parser.add_argument('--hidden_dim', type=int, default=30, metavar='H',
                       help='number of hidden layers of the model (default:30)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUT',
                       help='number of outputs of the model (default:1)')
